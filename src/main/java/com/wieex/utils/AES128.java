...
public class AES128 {
    ...
    private static void KeyExpansion(byte[] RoundKey, byte[] Key) {
        ...
        System.out.println("RoundKey : " + RoundKey.length);
    }
    ...
    public static void AES_ECB_encrypt(byte[] RoundKey, byte[] buf) {
        Cipher(buf, RoundKey);
    }
    ...
    public static int entry(byte[] message, int len) {
        ...
        for (int i = 0; i < len; i += 16) {
            ...
            System.out.println("324 roundKey : " + AesEcbCodec.encodeHexString(roundKey));
            System.out.println("325 data : " + AesEcbCodec.encodeHexString(data));
            AES_ECB_encrypt(roundKey, data); // reencrypt it to test
            System.out.println("327 roundKey : " + AesEcbCodec.encodeHexString(roundKey));
            System.out.println("328 data : " + AesEcbCodec.encodeHexString(data));

            AES_ECB_decrypt(roundKey, data); // if encrypt and decryption is symmetric

            System.out.println("332 roundKey : " + AesEcbCodec.encodeHexString(roundKey));
            System.out.println("333 data : " + AesEcbCodec.encodeHexString(data));
    ...
    public static void main(String[] args) {
        ...
        String uids = "00000000983055218826E6FFFFFFFFFF";
        String res = "5FAEB25A3E8626C6D6E2E01C4C96E79D";

        String t = "abcdefg";
        String hexstr = "61626364656667";
        ...
        byte out[] = {0x3a, (byte) 0xd7, 0x7b, (byte) 0xb4, 0x0d, 0x7a, 0x36, 0x60, (byte) 0xa8, (byte) 0x9e, (byte) 0xca, (byte) 0xf3, 0x24, 0x66, (byte) 0xef, (byte) 0x97};
        byte in[] = {0x6b, (byte) 0xc1, (byte) 0xbe, (byte) 0xe2, 0x2e, 0x40, (byte) 0x9f, (byte) 0x96, (byte) 0xe9, 0x3d, 0x7e, 0x11, 0x73, (byte) 0x93, 0x17, 0x2a};


        //byte RoundKey[] = new byte[176];
        //System.out.println("key : " + AesEcbCodec.encodeHexString(key));
        //AES_init_ctx(RoundKey, key);
        //System.out.println("RoundKey : " + AesEcbCodec.encodeHexString(RoundKey));
        //System.out.println("in : " + AesEcbCodec.encodeHexString(in));
        //AES_ECB_encrypt(RoundKey, in);
        //System.out.println("aes : " + AesEcbCodec.encodeHexString(in));
        //System.out.println("check : " + AesEcbCodec.encodeHexString(out));

        /*
        try {
            AES128.AES_ECB_encrypt( AesEcbCodec.decodeHex(hexKey)  ,AesEcbCodec.decodeHex(uids) );
        } catch (IOException e) {
        ...
        */
        ...
        try {
            ...
            byte cpuIds[] = AesEcbCodec.decodeHex(uids);

            System.out.println("in cpuIds : " + AesEcbCodec.encodeHexString(cpuIds));
            AES_ECB_encrypt(RoundKey, cpuIds);
            System.out.println("out cpuIds : " + AesEcbCodec.encodeHexString(cpuIds));
